...
>
> Если последние апдейты не нужны и вы хотите освободить дополнительное место, воспользуйтесь утилитой DefenderKiller, либо раскомментируйте строки 261-263 в батнике перед установкой WinClick.
#
...
> На слабых ПК может занимать много времени. Если сжатие не требуется, закомментируйте 735 строку в батнике перед установкой WinClick.
