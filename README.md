...
![Скачиваний](https://img.shields.io/github/downloads/MartyFiles/WinClick/latest/total?style=for-the-badge&label=Скачиваний&color=blue&logo=download)
...
#
### После запуска программы сразу же начнется настройка в 13 этапов:
