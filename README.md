...
- Удаление старых драйверов `(если запускаете на рабочей системе)`
#
...
>
> Если последние апдейты не нужны и вы хотите освободить дополнительное место, воспользуйтесь утилитой DefenderKiller, либо раскомментируйте строки 251-253 в батнике перед установкой WinClick.
#
...
> Установить их можно будет и без наличия Microsoft Store.
#
...
> На слабых ПК может занимать много времени. Если сжатие не требуется, закомментируйте 724 строку в батнике перед установкой WinClick.
