...
![Скачиваний](https://img.shields.io/github/downloads/MartyFiles/WinClick/total?style=for-the-badge&label=Скачиваний&color=blue&logo=download)
...
> [!Tip]
> Компонент `Язык сценариев VBScript` может быть нужен для установки некоторых специфических программ и драйверов.
>
