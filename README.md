...
>
> Если последние апдейты не нужны и вы хотите освободить дополнительное место, воспользуйтесь утилитой DefenderKiller, либо раскомментируйте строки 258-260 в батнике перед установкой WinClick.
#
...
> На слабых ПК может занимать много времени. Если сжатие не требуется, закомментируйте 731 строку в батнике перед установкой WinClick.
